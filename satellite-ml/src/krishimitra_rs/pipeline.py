...
from .models.crop_classifier import ClassificationResult, classify_crops
...
def run(
    ...
    _log(f"    best={crop.best_model}  OA={m['overall_accuracy']:.1%}  kappa={m['kappa']:.2f}")
...
def _save_artifacts(res: PipelineResult) -> None:
    ...
    # persist the deployed classifier
    try:
        import joblib
